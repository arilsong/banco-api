...
public class AuthorizationController {
    ...
    public String processLogin(@RequestParam("username") String username,
                             ...
                             HttpSession session,
                             Model model) {
        log.info("Processando login para Open Banking (Caixa): {}", username);
    ...
    public String processAuthorize(@RequestParam("action") String action,
        ...
        if ("confirm".equals(action)) {
            ...
            log.info("Consentimento confirmado para consentId (Caixa): {}. Gerando auth_code: {}", consentId, authCode);
            return "redirect:" + redirectUri + "?consentId=" + consentId + "&code=" + authCode;
        } else {
            log.info("Consentimento cancelado para consentId (Caixa): {}", consentId);
