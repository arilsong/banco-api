...
import com.caixa.api.config.FxConfig;
...
public class FxService {
    ...
    public Map<String, Object> processQuote(FxQuoteRequest request) {
        ...
        log.info("FX Quote [CAIXA]: {} {} → {} {} (rate={})", sourceAmt, sourceCurrency, targetAmt, targetCurrency, rate);
    ...
    public Map<String, Object> reserveTransfer(FxTransferRequest request) {
        ...
        log.info("FX Reservado [CAIXA]: {} {} → {} {} id={}", sourceAmt, sourceCurrency, targetAmt, targetCurrency, commitRequestId);
    ...
    public Map<String, Object> commitTransfer(String commitRequestId) {
        ...
        log.info("FX Confirmado [CAIXA]: id={}", commitRequestId);
        return Map.of(
                "completedTimestamp", Instant.now().toString(),
    ...
    public Map<String, Object> abortTransfer(String commitRequestId) {
        ...
        log.info("FX Abortado [CAIXA]: id={}", commitRequestId);
        return Map.of(
                "completedTimestamp", Instant.now().toString(),
