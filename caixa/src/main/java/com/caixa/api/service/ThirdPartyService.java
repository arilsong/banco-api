...
public class ThirdPartyService {
    ...
    public Map<String, Object> handleConsentRequestSync(Map<String, Object> body) {
        ...
        response.put("authUri", "http://63.250.57.157:8082/sdk/authorize?consentRequestId=" + consentRequestId);
    ...
    public Map<String, Object> validateConsentRequestSync(Map<String, Object> body) {
        ...
        data.put("authUri", "http://63.250.57.157:8082/sdk/authorize?consentRequestId=" + consentRequestId);
    ...
    public void handleTransactionRequest(Map<String, Object> body, String fspiSource) {
        ...
        log.info("TransactionRequest recebido: id={} authId={}", transactionRequestId, authorizationRequestId);
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                Map<String, Object> receivedCallback = new LinkedHashMap<>();
    ...
    public void handleAuthorization(String authorizationRequestId, Map<String, Object> body, String fspiSource) {
        ...
        log.info("Authorization recebida: authId={} transactionRequestId={}", authorizationRequestId, transactionRequestId);
    ...
    @SuppressWarnings("unchecked")
    private List<Map<String, Object>> transformScopes(Map<String, Object> body) {
        List<Map<String, Object>> result = new ArrayList<>();
        if (!body.containsKey("scopes")) return result;
        List<Map<String, Object>> incoming = (List<Map<String, Object>>) body.get("scopes");
        for (Map<String, Object> scope : incoming) {
