...
public class TransferService {
    ...
    private final com.caixa.api.core.repository.CoreTransactionRepository transactionRepository;
    ...
    public TransferResponse processTransfer(TransferRequest request) {
        ...
        if (txAmount == null) {
            ...
            return TransferResponse.builder()
                .homeTransactionId("caixa-error-" + UUID.randomUUID().toString().substring(0, 8))
        ...
        if (request.getFrom() != null) {
            ...
            partyService.findAccountByIdType(fromType, fromId).ifPresent(payer -> {
                ...
                transactionRepository.save(com.caixa.api.core.model.CoreTransaction.builder()
        ...
        String homeTxId = "caixa-core-" + UUID.randomUUID().toString().substring(0, 8);
        return TransferResponse.builder()
