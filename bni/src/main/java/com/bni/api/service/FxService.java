...
import com.bni.api.config.FxConfig;
import com.bni.api.dto.FxQuoteRequest;
import com.bni.api.dto.FxTransferRequest;
...
public class FxService {
    ...
    public Map<String, Object> processQuote(FxQuoteRequest request) {
        ...
        log.info("FX Quote [BNI]: {} {} → {} {} (rate={})", sourceAmt, sourceCurrency, targetAmt, targetCurrency, rate);
    ...
    public Map<String, Object> reserveTransfer(FxTransferRequest request) {
        ...
        log.info("FX Reservado [BNI]: {} {} → {} {} id={}", sourceAmt, sourceCurrency, targetAmt, targetCurrency, commitRequestId);
    ...
    public Map<String, Object> commitTransfer(String commitRequestId) {
        ...
        log.info("FX Confirmado [BNI]: id={}", commitRequestId);
        return Map.of(
                "completedTimestamp", Instant.now().toString(),
    ...
    public Map<String, Object> abortTransfer(String commitRequestId) {
        ...
        log.info("FX Abortado [BNI]: id={}", commitRequestId);
        return Map.of(
                "completedTimestamp", Instant.now().toString(),
