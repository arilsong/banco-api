...
public class QuoteService {
    ...
    public QuoteResponse processQuote(QuoteRequest request) {
        ...
        return QuoteResponse.builder()
                ...
                .transferAmount(new BigDecimal(amountValue).stripTrailingZeros().toPlainString())
                .transferAmountCurrency(currency)
                .payeeReceiveAmount(payeeReceives.stripTrailingZeros().toPlainString())
                .payeeReceiveAmountCurrency(currency)
                .payeeFspFee(fee.stripTrailingZeros().toPlainString())
